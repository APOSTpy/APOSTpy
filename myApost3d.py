...
# highest angular momentum
    ...
    if highest_angular_mom >4 :
      print('CAN NOT HANDLE H-TYPE FUNCTIONS')
      exit()
#shells per atom
...
# For Pure basis functions
        ...
        for i in mol.ao_labels():
            ...
            # Orbitales g
                ...
                imap[contador] += 3
            elif i.find('g+0') != -1 or i.find('g 0') != -1:
                imap[contador] -= 2
            elif i.find('g+1') != -1 or i.find('g 1') != -1:
                imap[contador] += 2
            elif i.find('g+2') != -1 or i.find('g 2') != -1:
                imap[contador] -= 5
            elif i.find('g+3') != -1 or i.find('g 3') != -1:
                imap[contador] += 1
            elif i.find('g+4') != -1 or i.find('g 4') != -1:
                imap[contador] -= 8
...
import numpy
from pyscf import mcscf,fci
def write_fulldm_old(mol, mycas, titol,myhf=None):
